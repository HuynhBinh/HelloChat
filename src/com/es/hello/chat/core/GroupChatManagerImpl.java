...
public class GroupChatManagerImpl extends QBMessageListenerImpl<QBGroupChat> implements ChatManager, QBParticipantListener
{
    ...
    // called when join the group chat 1st time
    ...
    // called each time user join the group chat
    @SuppressWarnings("rawtypes")
    ...
    // receive message from other opponents
    @Override
    ...
    // QB does not make this function work for group chat
    @Override
