...
// This is where we process the incomming push nitification 
public class GCMIntentService extends IntentService
{
	...
	try
	{
	    ...
	    if (pushtype.equalsIgnoreCase("new_message")) // notify when there
							  // is new message
	    {
	    ...
	    else if (pushtype.equalsIgnoreCase("blockuser")) // notify when you
							     // are blocked by
							     // other user
	    {
	    ...
	    else if (pushtype.equalsIgnoreCase("update_group_profile")) // notify
									// when
									// group
									// profile
									// had
	    ...
	    else if (pushtype.equalsIgnoreCase("leavegroup")) // notify when
							      // user leave
							      // group
	    {
	    ...
	    else if (pushtype.equalsIgnoreCase("joingroup")) // // notify when
							     // user join group
	    {
	    ...
	    else if (pushtype.equalsIgnoreCase("youareinvited")) // notify when
								 // you are
								 // invited to
								 // group
	    {
	    ...
	    else if (pushtype.equalsIgnoreCase("createnewgroup")) // notify when
								  // there is a
								  // new group
	    {
		dialog_ID = obj.getString("dialog_id");
    ...
    // check if Chat Screen is running
    ...
    // notification on statusbar when user join or leave group
    ...
    // load new room profile from server
