...
public class DialogsActivity extends ActionBarActivity implements HelloMainService.ServiceInterfaceCallback, ChatActivity.ChatCallback, HelloMainService.ConnectionInterfaceCallback
{
    ...
    // awake when there is specific event
	...
	public void onReceive(Context context, Intent intent)
	{
	    ...
	    // update UI when there is new message or new room
	    ...
	    { // update UI when group profile had changed
		String dialog_id = intent.getExtras().getString("DIALOG_ID");
    ...
    // add move down button to screen
    ...
    // load rooms
    // if existing -> load from local db
    ...
    // convert local data type to server data type
    // local room to server room type
    ...
    // update UI listview incase data changed
    ...
    // update UI if there is new chat room came
    ...
    // find last time to update room last message time
