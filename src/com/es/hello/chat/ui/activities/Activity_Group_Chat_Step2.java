...
// this screen is for select friend to add to the group
public class Activity_Group_Chat_Step2 extends ActionBarActivity
{
    ...
    // after create the group success, start the group chat
    ...
    // create group chat without photo
    ...
    // create group chat with photo
    // 1. upload photo to server
    // 2. create new group and attach that photo as group's photo
    ...
    // send notification to all member in the new created group that there is a new group
